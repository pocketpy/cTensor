...
void test_min_operator() {
    ...
    // Test Case 7: Min over a specific dimension of a matrix (dim=0)
    {
        const char* tc_name = "min_matrix_dim_0";
        TensorShape m_shape = {2, 3};
        float d1[] = {5.0f, -1.0f, 7.0f, 2.0f, -8.0f, 6.0f};
        float exp_d[] = {2.0f, -8.0f, 6.0f};
        float exp_idx[] = {1.0f, 1.0f, 1.0f};
    ...
    {
        const char* tc_name = "min_matrix_dim_1";
        TensorShape m_shape = {2, 3};
        float d1[] = {5.0f, -1.0f, 7.0f, 2.0f, -8.0f, 6.0f};
        float exp_d[] = {-1.0f, -8.0f};
        float exp_idx[] = {1.0f, 1.0f};
