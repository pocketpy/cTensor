...
void test_mul_operator() {
    ...
    // Test Case 7: Higher Dimensional Tensors
    {
        ...
        // Sub-test 1: 3D tensor multiplication (same shape)
        {
            ...
            float exp_d[] = {0.0248f, 0.2581f, 0.0871f, 0.0229f, 0.0554f, 0.4516f, 0.1016f, 0.1198f, 0.3189f, 0.1658f, 0.0030f, 0.1030f, 0.0804f, 0.0124f, 0.1213f, 0.5902f, 0.0111f, 0.0957f, 0.7230f, 0.3546f, 0.1232f, 0.0361f, 0.0712f, 0.0198f};
        ...
        // Sub-test 2: 4D tensor multiplication (same shape)
        {
            ...
            float exp_d[] = {0.1436f, 0.3319f, 0.1776f, 0.4063f, 0.0333f, 0.1576f, 0.0834f, 0.8413f, 0.3212f, 0.1782f, 0.0149f, 0.3553f, 0.3303f, 0.1293f, 0.2407f, 0.2975f, 0.0030f, 0.1004f, 0.0525f, 0.2436f, 0.0040f, 0.5075f, 0.4526f, 0.5954f, 0.2700f, 0.4093f, 0.0096f, 0.4546f, 0.0748f, 0.2962f, 0.3442f, 0.0191f, 0.0651f, 0.2622f, 0.4651f, 0.3660f, 0.2471f, 0.5354f, 0.1525f, 0.0820f, 0.0185f, 0.1389f, 0.1435f, 0.0644f, 0.0862f, 0.2701f, 0.0266f, 0.5257f, 0.0406f, 0.3207f, 0.0074f, 0.8568f, 0.1044f, 0.2248f, 0.6754f, 0.7984f, 0.5779f, 0.0393f, 0.0985f, 0.4057f, 0.3942f, 0.4100f, 0.5341f, 0.2591f, 0.3469f, 0.0212f, 0.3188f, 0.3569f, 0.0633f, 0.2232f, 0.0999f, 0.3168f, 0.1707f, 0.2319f, 0.0085f, 0.1613f, 0.4276f, 0.0002f, 0.1123f, 0.0535f, 0.0341f, 0.9106f, 0.1116f, 0.2810f, 0.1878f, 0.3082f, 0.1708f, 0.2695f, 0.0664f, 0.0726f, 0.1739f, 0.3894f, 0.7599f, 0.3497f, 0.0722f, 0.4621f, 0.0123f, 0.1203f, 0.0118f, 0.7123f, 0.0854f, 0.3490f, 0.0119f, 0.7928f, 0.1013f, 0.0974f, 0.0110f, 0.6109f, 0.1396f, 0.4697f, 0.0736f, 0.1673f, 0.0143f, 0.3855f, 0.2480f, 0.0248f, 0.3588f, 0.1366f, 0.3920f, 0.2216f};
